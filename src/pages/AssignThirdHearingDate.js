...
const AssignThirdHearingDate = () => {
  ...
  const handleThirdHearing = async () => {
    if (!selectedDate) {
    ...
    <div className="container">
      <div className="row my-2">
        <div className="col-md-5">
          <h4>Assign Third Hearing Date</h4>
        </div>
      </div>
      <div className="row d-flex align-items-center">
        ...
        {secondDate && (
          <>
            ...
            <div className="col-md-3">
              <button className="custBtn" onClick={handleThirdHearing}>
                Set Date
              </button>
            </div>
          </>
...
export default AssignThirdHearingDate;
