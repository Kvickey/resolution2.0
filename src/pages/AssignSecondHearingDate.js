...
const AssignSecondHearingDate = () => {
  ...
  const handleSecondHearing = async () => {
    if (!selectedDate) {
    ...
    <div className="container">
      <div className="row my-2">
        <div className="col-md-5">
          <h4>Assign Second Hearing Date</h4>
        </div>
      </div>
      <div className="row d-flex align-items-center">
        {!secondDate && (
          <>
            <div className="col-md-3">
              <label htmlFor="datePicker">Select First Hearing Date</label>
            </div>
            <div className="col-md-3">
              <DatePicker
                id="datePicker"
        ...
        {secondDate && (
          <>
            <div className="col-md-3">
              <label htmlFor="datePicker">Select Second Hearing Date</label>
            </div>
            <div className="col-md-3">
              <DatePicker
                id="datePicker"
            ...
            <div className="col-md-3">
              <button className="custBtn" onClick={handleSecondHearing}>
                Set Date
              </button>
            </div>
          </>
...
export default AssignSecondHearingDate;
